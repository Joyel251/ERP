  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        >
          <motion.h1
            className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-slate-800 via-blue-600 to-slate-800 mb-6 leading-tight tracking-tight"
            animate={{
          ...
          >
            <motion.h2
              className="text-3xl font-semibold text-slate-700 leading-tight mb-3"
              animate={{
            ...
            <motion.h3
              className="text-2xl font-medium text-slate-600 leading-tight mb-4"
              animate={{
                opacity: [0.8, 1, 0.8],
              }}
              transition={{
            ...
            <motion.p
              className="text-3xl font-bold tracking-wider text-blue-600"
              animate={{
                scale: [1, 1.02, 1],
              }}
              transition={{
              ...
              <CardContent className="p-6 relative z-10">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1 text-left">
                    <h3 className="font-semibold text-slate-800 group-hover:text-blue-700 transition-colors duration-300 text-lg">
                      {option.title}
                    </h3>
